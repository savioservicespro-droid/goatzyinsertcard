 ...
 */
const ReviewStep = ({ onAmazonRedirect, onClaimGifts, onReviewGenerated, onBack, deepseekPrompt, productName }) => {
  ...
  const handleGenerateReview = async () => {
    ...
    try {
      const review = await generateReview(stars, tone, deepseekPrompt, productName);
